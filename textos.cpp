...
//  ------------------------------------------------------------------------------------------------------------------
    ...
    "Los koalas tienen huellas dactilares tan parecidas a las humanas que podrian confundir en una escena del crimen.",
    ...
    "*Lo primero que veo son 0 flamencos que adquieren su caracteristico color rosa gracias a la dieta  en carotenoides.",
    ...
    "El Sol representa el 99% de toda la masa del sistema solar, dejando menos del 1% para planetas, lunas y asteroides.",
    ...
    "Las estrellas de mar no tienen cerebro ni sangre; usan un sistema hidraulico para moverse y agua actua como su 'sangre'.",
    ...
    "Los canguros no pueden caminar hacia atras debido a la estructura de sus patas y la cola que les sirve de equilibrio.",
    ...
    "Los glaciares almacenan casi el 69% del agua dulce de la Tierra, y su derretimiento amenaza con elevar niveles del mar.",
